"""
M22 Security Simulation Package & SecuritySimulationEngine Facade.

Provides safe security simulation, reachability validation, scenario generation,
sandboxed execution, differential repair analysis, and safety gate enforcement.
"""
...
from agentos_swe.simulation.safety import SimulationSafetyGate
from agentos_swe.simulation.reachability import SimulationReachabilityAnalyzer
from agentos_swe.simulation.scenarios import SecurityScenarioGenerator
from agentos_swe.simulation.executor import SecuritySimulationExecutor
from agentos_swe.simulation.evidence import SimulationEvidenceBuilder
from agentos_swe.simulation.differential import SimulationDifferentialAnalyzer
