...
from agentos_swe.operations.monitoring.snapshot_manager import SnapshotManager
from agentos_swe.operations.monitoring.change_detector import ChangeDetector
from agentos_swe.operations.monitoring.regression_detector import RegressionDetector
from agentos_swe.operations.monitoring.trend_analyzer import TrendAnalyzer
from agentos_swe.operations.monitoring.alert_engine import AlertEngine
...
class SecurityMonitoringEngine:
    ...
    def __init__(self):
        from agentos_swe.operations.monitoring.snapshot import SecuritySnapshotEngine
        from agentos_swe.operations.monitoring.drift import SecurityDriftAnalyzer
        from agentos_swe.operations.monitoring.changes import SecurityChangeAnalyzer
        from agentos_swe.operations.monitoring.impact import SecurityChangeImpactCorrelator
        from agentos_swe.operations.monitoring.alerts import SecurityAlertEngine
        from agentos_swe.operations.monitoring.scheduler import SecurityMonitorScheduler
        from agentos_swe.operations.monitoring.models import DriftScoreCategory, ReleaseDriftAssessment, HistoricalDriftContext
